...
public class SnackAndLadder {
   ...
   public static void main(String args[]){
      ...
      final int Ladder = 2;
       ...
       switch(die1){
           case NO_PLAY:System.out.println("Player does not play");
                        pos = pos;
                        System.out.println("Player at position"+pos);
           break;
           case SNACK: System.out.println("Player get the snack");
               pos -= die;
                  if(pos <0) {
                      pos = 0;
                      System.out.println("Player at position" + pos);
               ...
               break;
           case Ladder: System.out.println("Player get the ladder");
                        pos += die;
                        System.out.println("Player at position"+die1);
               break;
       }
